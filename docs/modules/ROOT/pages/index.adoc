...
Kroki.io is a tool that renders diagrams from code allowing developers to write diagrams as code.
...
[source, bash]
----
docker run --rm -p 3000:3000 sommerfeldio/krokidile:latest --kroki-url=https://kroki.io
----
